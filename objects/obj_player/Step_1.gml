...
if (state==2) /* TODO: check that 'state' has an appropriate value here (replace false) */ exit;
...
if (state!=2) /* TODO: check that 'state' has an appropriate value here (replace false) */ {
...
else if keyboard_check_pressed(ord("E"))
{
	...
	if state==1 /* TODO: check that 'state' has an appropriate value here (replace false) */ {
...
if (state=1 /* TODO: check that 'state' has an appropriate value here (replace false) */) with grabTarget {
